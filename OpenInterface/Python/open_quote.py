...
class MarketSnapshotQuery:
    ...
    def unpack_rsp(cls, rsp_str):
        ...
        snapshot_list = [{'code': _merge_stock_str(int(record['MarketType']), record['StockCode']),
...
class ExrightQuery:
    ...
    def unpack_rsp(cls, rsp_str):
        ...
        exr_list = [{'code': _merge_stock_str(int(record['Market']), record['StockCode']),
...
def get_history_kline(code, start=None, end=None, ktype='K_DAY', autype='qfq'):
    query_processor = _get_query_processor(HistoryKlineQuery.pack_req,
...
def get_autype_list(code_list):
    query_processor = _get_query_processor(ExrightQuery.pack_req,
...
def get_market_snapshot(code_list):
    query_processor = _get_query_processor(MarketSnapshotQuery.pack_req,
