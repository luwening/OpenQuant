...
void CPluginPushBatchBasic::SetQuoteReqData(int nCmdID, const Json::Value &jsnVal, SOCKET sock)
{
...
void CPluginPushBatchBasic::NotifyQuoteDataUpdate(int nCmdID, INT64 nStockID)
{
...
void CPluginPushBatchBasic::PushStockData(INT64 nStockID, SOCKET sock)
{
	...
	if (m_pQuoteData->FillBatchBasic(nStockID, &batchprice))
	{
		...
		Item.strStockCode.assign(wstrStockCode.begin(), wstrStockCode.end());
...
void CPluginPushBatchBasic::OnTimeEvent(UINT nEventID)
{
...
void CPluginPushBatchBasic::OnMsgEvent(int nEvent,WPARAM wParam,LPARAM lParam)
{
...
void CPluginPushBatchBasic::ClearQuoteDataCache()
{
...
void CPluginPushBatchBasic::HandleTimeoutReq()
{
...
void CPluginPushBatchBasic::ReplyAllReadyReq()
{
	DWORD dwTickNow = ::GetTickCount();
	MAP_STOCK_DATA_REQ::iterator it_stock = m_mapReqInfo.begin();
	for ( ; it_stock != m_mapReqInfo.end(); )
...
void CPluginPushBatchBasic::ReplyStockDataReq(StockDataReq *pReq, const QuoteAckDataBody &data)
{
...
void CPluginPushBatchBasic::ReplyDataReqError(StockDataReq *pReq, int nErrCode, LPCWSTR pErrDesc)
{
	CHECK_RET(pReq && m_pQuoteServer, NORET);
...
void CPluginPushBatchBasic::SetTimerHandleTimeout(bool bStartOrStop)
{
...
void CPluginPushBatchBasic::SetTimerClearCache(bool bStartOrStop)
{
...
bool CPluginPushBatchBasic::GetStockMktCode(INT64 nStockID, StockMktCode &stkMktCode)
{
...
void CPluginPushBatchBasic::ClearAllReqCache()
{
	MAP_STOCK_DATA_REQ::iterator it_stock = m_mapReqInfo.begin();
