...
class CPluginPushKLData : public CTimerWndInterface, public CMsgHandlerEventInterface
{
public:
	CPluginPushKLData();
	...
	void PushStockData(INT64 nStockID, SOCKET sock, StockSubType eStockSubType, DWORD dwTime);
