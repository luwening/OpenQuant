...
class CPluginCheckSecNum : public CTimerWndInterface, public CMsgHandlerEventInterface
{
public:
	CPluginCheckSecNum();
	virtual ~CPluginCheckSecNum();
...
protected:
	//tomodify 1
	typedef CheckSecNum_Req	TradeReqType;
	typedef CheckSecNum_Ack	TradeAckType;
