...
void CProtoStockList::GetStructField4ParseJson_v0(bool bReqOrAck, int nLevel, const std::string &strStructName, VT_PROTO_FIELD &vtField, void *pStruct)
{
	...
	else if ( nLevel == 3 && !bReqOrAck && strStructName == "BasicInfoArr" )
	{
		...
		static EProtoFildType arFieldType[] = {
			...
			ProtoFild_Int32,
			ProtoFild_Int32, ProtoFild_StringA, ProtoFild_Int32, ProtoFild_StringA,
		...
		static LPCSTR arFieldKey[] = {
			...
			"StockName",		"StockCode",
			"StockType", 
			"StockChildType", "OwnerStockCode", "OwnerMarketType", "ListTime"
		};
		...
		void *arPtr[] = {
			...
			&pStockItem->nSubType, &pStockItem->strOwnerStockCode, &pStockItem->nOwnerMarketType, &pStockItem->strListDate
		};
