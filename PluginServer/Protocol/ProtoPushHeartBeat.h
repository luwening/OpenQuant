...
class CProtoPushHeartBeat : public CProtoParseBase
{
public:
	//tomodify 1
	typedef PushHeartBeat_Req		ProtoReqDataType;
	typedef PushHeartBeat_Ack		ProtoAckDataType;

	//tomodify 2
	typedef PushHeartBeatReqBody	ProtoReqBodyType;
	typedef PushHeartBeatAckBody	ProtoAckBodyType;

public:
	CProtoPushHeartBeat();
	virtual ~CProtoPushHeartBeat();
