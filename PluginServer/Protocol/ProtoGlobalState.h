...
class CProtoGlobalState : public CProtoParseBase
{
public:
	//tomodify 1
	typedef GlobalState_Req		ProtoReqDataType;
	typedef GlobalState_Ack		ProtoAckDataType;

	//tomodify 2
	typedef GlobalStateReqBody	ProtoReqBodyType;
	typedef GlobalStateAckBody	ProtoAckBodyType;


public:
	CProtoGlobalState();
	virtual ~CProtoGlobalState();
