...
class CProtoPushStockData : public CProtoParseBase
{
public:
	//tomodify 1
	typedef PushStockData_Req		ProtoReqDataType;
	typedef PushStockData_Ack		ProtoAckDataType;

	//tomodify 2
	typedef PushStockDataReqBody	   ProtoReqBodyType;
	typedef PushStockDataAckBody	   ProtoAckBodyType;


public:
	CProtoPushStockData();
	virtual ~CProtoPushStockData();
