...
CProtoPushTickerPrice::CProtoPushTickerPrice()
{
	m_pReqData = NULL;
	m_pAckData = NULL;
}
...
bool CProtoPushTickerPrice::ParseJson_Req(const Json::Value &jsnVal)
{
...
bool CProtoPushTickerPrice::ParseJson_Ack(const Json::Value &jsnVal)
{
...
bool CProtoPushTickerPrice::MakeJson_Req(Json::Value &jsnVal)
{
	CHECK_RET(m_pReqData != NULL, false);
...
bool CProtoPushTickerPrice::MakeJson_Ack(Json::Value &jsnVal)
{
	CHECK_RET(m_pAckData != NULL, false);
...
void CProtoPushTickerPrice::SetProtoData_Req(ProtoReqDataType *pData)
{
	m_pReqData = pData;
}

void CProtoPushTickerPrice::SetProtoData_Ack(ProtoAckDataType *pData)
{
	m_pAckData = pData;
}

void CProtoPushTickerPrice::GetStructField4ParseJson_v0(bool bReqOrAck, int nLevel, const std::string &strStructName, VT_PROTO_FIELD &vtField, void *pStruct)
{
...
void CProtoPushTickerPrice::GetStructField4ParseJson(bool bReqOrAck, int nLevel, const std::string &strStructName, VT_PROTO_FIELD &vtField, void *pStruct)
{
	GetStructField4ParseJson_v0(bReqOrAck, nLevel, strStructName, vtField, pStruct);
	return ;
}

void CProtoPushTickerPrice::GetStructField4MakeJson(bool bReqOrAck, int nLevel, const std::string &strStructName, VT_PROTO_FIELD &vtField, void *pStruct)
{
	GetStructField4ParseJson_v0(bReqOrAck, nLevel, strStructName, vtField, pStruct);
	return ;	
}
...
void CProtoPushTickerPrice::GetArrayField4ParseJson(bool bReqOrAck, int nLevel, const std::string &strArrayName, int nJsnArrSize, VT_PROTO_FIELD &vtField, void *pVector)
{
	...
	if ( !bReqOrAck && nLevel == 2 && strArrayName == "TickerArr" )
	{
		...
		VT_TICKER_DATA_PUSH &vtTickData = *(VT_TICKER_DATA_PUSH*)pVector;
...
void CProtoPushTickerPrice::GetArrayField4MakeJson(bool bReqOrAck, int nLevel, const std::string &strArrayName, VT_PROTO_FIELD &vtField, void *pVector)
{
...
void  CProtoPushTickerPrice::GetProtoReqBodyFields(VT_PROTO_FIELD &vtField, void *pStruct)
{
...
void  CProtoPushTickerPrice::GetProtoAckBodyFields(VT_PROTO_FIELD &vtField, void *pStruct)
{
