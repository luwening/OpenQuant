...
CProtoGlobalState::CProtoGlobalState()
{
	m_pReqData = NULL;
	m_pAckData = NULL;
}
...
bool CProtoGlobalState::ParseJson_Req(const Json::Value &jsnVal)
{
...
bool CProtoGlobalState::ParseJson_Ack(const Json::Value &jsnVal)
{
...
bool CProtoGlobalState::MakeJson_Req(Json::Value &jsnVal)
{
	CHECK_RET(m_pReqData != NULL, false);
...
bool CProtoGlobalState::MakeJson_Ack(Json::Value &jsnVal)
{
	CHECK_RET(m_pAckData != NULL, false);
...
void CProtoGlobalState::SetProtoData_Req(ProtoReqDataType *pData)
{
	m_pReqData = pData;
}

void CProtoGlobalState::SetProtoData_Ack(ProtoAckDataType *pData)
{
	m_pAckData = pData;
}

//tomodify 3(数组等复杂结构或单层的结构体)
bool CProtoGlobalState::ParseProtoBody_Req(const Json::Value &jsnVal, ProtoReqDataType &data)
{	
...
bool CProtoGlobalState::ParseProtoBody_Ack(const Json::Value &jsnVal, ProtoAckDataType &data)
{
...
bool CProtoGlobalState::MakeProtoBody_Req(Json::Value &jsnVal, const ProtoReqDataType &data)
{
...
bool CProtoGlobalState::MakeProtoBody_Ack(Json::Value &jsnVal, const ProtoAckDataType &data)
{
...
//tomodify 7
void CProtoGlobalState::GetProtoBodyField_Req(VT_PROTO_FIELD &vtField, const ProtoReqBodyType &reqData)
{
...
//tomodify 8
void CProtoGlobalState::GetProtoBodyField_Ack(VT_PROTO_FIELD &vtField, const ProtoAckBodyType &ackData)
{
	static BOOL arOptional[] = {
		FALSE, FALSE,  FALSE,
		FALSE, FALSE, 
	...
	void *arPtr[] = {
		...
		&body.nQuoteLogined, &body.nTradeLogined,
	};
