...
class CProtoCheckSecNum : public CProtoParseBase
{
public:
	//tomodify 1
	typedef CheckSecNum_Req		ProtoReqDataType;
	typedef CheckSecNum_Ack		ProtoAckDataType;

	//tomodify 2
	typedef CheckSecNumReqBody	   ProtoReqBodyType;
	typedef CheckSecNumAckBody	   ProtoAckBodyType;


public:
	CProtoCheckSecNum();
	virtual ~CProtoCheckSecNum();
