...
CProtoPushRTData::CProtoPushRTData()
{
	m_pReqData = NULL;
	m_pAckData = NULL;
}
...
bool CProtoPushRTData::ParseJson_Req(const Json::Value &jsnVal)
{
...
bool CProtoPushRTData::ParseJson_Ack(const Json::Value &jsnVal)
{
...
bool CProtoPushRTData::MakeJson_Req(Json::Value &jsnVal)
{
	CHECK_RET(m_pReqData != NULL, false);
...
bool CProtoPushRTData::MakeJson_Ack(Json::Value &jsnVal)
{
	CHECK_RET(m_pAckData != NULL, false);
...
void CProtoPushRTData::SetProtoData_Req(ProtoReqDataType *pData)
{
	m_pReqData = pData;
}

void CProtoPushRTData::SetProtoData_Ack(ProtoAckDataType *pData)
{
	m_pAckData = pData;
}

//tomodify 3(数组等复杂结构或单层的结构体)
bool CProtoPushRTData::ParseProtoBody_Req(const Json::Value &jsnVal, ProtoReqDataType &data)
{	
...
bool CProtoPushRTData::ParseProtoBody_Ack(const Json::Value &jsnVal, ProtoAckDataType &data)
{
...
bool CProtoPushRTData::MakeProtoBody_Req(Json::Value &jsnVal, const ProtoReqDataType &data)
{
...
bool CProtoPushRTData::MakeProtoBody_Ack(Json::Value &jsnVal, const ProtoAckDataType &data)
{
...
//tomodify 7
void CProtoPushRTData::GetProtoBodyField_Req(VT_PROTO_FIELD &vtField, const ProtoReqBodyType &reqData)
{
...
//tomodify 8
void CProtoPushRTData::GetProtoBodyField_Ack(VT_PROTO_FIELD &vtField, const ProtoAckBodyType &ackData)
{
	static BOOL arOptional[] = {
		FALSE, FALSE, FALSE,
	};
...
bool CProtoPushRTData::ParseRTDataArr(const Json::Value &jsnRetData, ProtoAckBodyType &data)
{
...
bool CProtoPushRTData::MakeRTDataArr(Json::Value &jsnRetData, const ProtoAckBodyType &data)
{
	...
	{
		const PushRTDataAckItem &item = data.vtRTData[n];
		VT_PROTO_FIELD vtField;
		GetRTDataArrField(vtField, item);
...
void CProtoPushRTData::GetRTDataArrField(VT_PROTO_FIELD &vtField, const PushRTDataAckItem &ackItem)
{
	static BOOL arOptional[] = {
		FALSE, FALSE, FALSE,
		FALSE, FALSE, FALSE,		
	...
	PushRTDataAckItem &item = const_cast<PushRTDataAckItem &>(ackItem);
	void *arPtr[] = {
