...
class CPluginQueryUSAccInfo : public CTimerWndInterface, public CMsgHandlerEventInterface
{
public:
	CPluginQueryUSAccInfo();
	virtual ~CPluginQueryUSAccInfo();
...
protected:
	//tomodify 1
	typedef QueryUSAccInfo_Req	TradeReqType;
	typedef QueryUSAccInfo_Ack	TradeAckType;
