...
class CPluginPushTickerPrice : public CTimerWndInterface, public CMsgHandlerEventInterface
{
	//tomodify 1
...
public:
	...
	void PushStockData(INT64 ddwStockHash, SOCKET sock, INT64 nSequence);
