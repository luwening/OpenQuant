...
class CPluginPushBatchBasic : public CTimerWndInterface, public CMsgHandlerEventInterface
{
public:
...
protected:
	...
	typedef std::map<std::pair<SOCKET, DWORD>, VT_STOCK_DATA_REQ>	MAP_STOCK_DATA_REQ;
	typedef std::map<std::pair<SOCKET, DWORD>, QuoteAckDataBody>	MAP_STOCK_CACHE_DATA;
